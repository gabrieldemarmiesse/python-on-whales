...
from python_on_whales.utils import run, to_list, ValidPath
...
class StackCLI(DockerCLICaller):
    def deploy(self, name: str, compose_files: Union[ValidPath, List[ValidPath]] = [],
        ...
        full_cmd.add_simple_arg("--resolve_image", resolve_image)
