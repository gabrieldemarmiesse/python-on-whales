...
class SwarmCAConfig(DockerCamelModel):
    ...
    external_ca:  Optional[List[Any]] = pydantic.Field(None, alias="ExternalCA")  # TODO: set type
...
class SystemInfo(DockerCamelModel):
    ...
    bridge_nf_ip6tables:  Optional[bool] = pydantic.Field(None, alias="BridgeNfIp6tables")
    debug:  Optional[bool]
    ...
    generic_resources:  Optional[List[python_on_whales.components.node.models.NodeGenericResource]]
